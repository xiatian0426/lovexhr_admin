...
function dTree(objName) {
	...
	this.icon = {
		...
		root				: 'images/icon/empty.gif',

		folder			: 'images/icon/empty.gif',

		folderOpen	: 'images/icon/empty.gif',

		node				: 'images/icon/empty.gif',
...
dTree.prototype.s = function(id) {
	var text=document.getElementById("s" + this.obj + id).innerHTML;
