				...
				<div class="container-fluid">
					<div class="customerSearchBar">
						<ul class="nav navbar-nav nav-pills">
							<li class="active" onclick="functionChange('/frontData/list')"><a href="javascript:void(0);">&nbsp;&nbsp;&nbsp;&nbsp;前端列表&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
							<li onclick="functionChange('/frontData/goAdd')"><a href="javascript:void(0);">&nbsp;&nbsp;&nbsp;&nbsp;新增数据&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						</ul>
					</div>
				</div>
			</nav>
		</div>
		<iframe id="detailFrame" name="detailFrame" scrolling="yes" src="/frontData/list" frameborder="0" style="height: 600px;width: 100%;"></iframe>
	</body>
</html>
