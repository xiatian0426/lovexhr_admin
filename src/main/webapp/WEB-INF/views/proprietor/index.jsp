				...
				<div class="container-fluid">
					<div class="customerSearchBar">
						<ul class="nav navbar-nav nav-pills">
							<li class="active" onclick="functionChange('/proprietor/list')"><a href="javascript:void(0);">&nbsp;&nbsp;&nbsp;&nbsp;业主列表&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
							<li onclick="functionChange('/proprietor/goAdd')"><a href="javascript:void(0);">&nbsp;&nbsp;&nbsp;&nbsp;新增业主&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						</ul>
					</div>
				</div>
			</nav>
		</div>
		<iframe id="detailFrame" name="detailFrame" scrolling="yes" src="/proprietor/list" frameborder="0" style="height: 600px;width: 100%;"></iframe>
	</body>
</html>
